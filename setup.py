...
version_file = 'ACT_SR/version.py'
...
if __name__ == '__main__':
    ...
    setup(
        ...
        author_email='kangyingdong21@whu.edu.cn',
        keywords='computer vision, restoration, super resolution, remote sensing',
        url='https://github.com/YingdongKang/ACT_SR',
